...
Usage:
    ...
    python3 scripts/sync.py --dry-run   # validate and record payloads, do not push
...
def main():
    parser = argparse.ArgumentParser(description="Sync course content to Canvas.")
    parser.add_argument("--dry-run", action="store_true",
                        help="Validate content and record payloads without pushing to Canvas")
